...
public class Script_Enemy_Bruiser : MonoBehaviour{
    ...
    public void Headbutt() {
        GameObject playerHit = Instantiate(headbuttObj, rightFoot.transform.position, rightFoot.transform.rotation);
    }
    ...
    #endregion
    #region Headbutt Animation Controls
    ...
    public void TurnOffAttack() {
        resetAnimation();
        Debug.Log("Turning animation to idle");
        anim.SetBool("isIdle", true);
    }
    #endregion
